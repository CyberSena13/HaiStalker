...
def loginSC():
	...
	if username =="Cyber" and password =="Sena13":
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/CyberSena13')
				menu()
